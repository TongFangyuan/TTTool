...
NSString *const kTTKeychainErrorDomain = @"com.samsoffes.sskeychain";

NSString *const kTTKeychainAccountKey = @"acct";
NSString *const kTTKeychainCreatedAtKey = @"cdat";
NSString *const kTTKeychainClassKey = @"labl";
NSString *const kTTKeychainDescriptionKey = @"desc";
NSString *const kTTKeychainLabelKey = @"labl";
NSString *const kTTKeychainLastModifiedKey = @"mdat";
NSString *const kTTKeychainWhereKey = @"svce";
...
+ (NSArray *)accountsForService:(NSString *)service error:(NSError **)error {
    OSStatus status = TTKeychainErrorBadArguments;
    ...
    if (status != noErr && error != NULL) {
        *error = [NSError errorWithDomain:kTTKeychainErrorDomain code:status userInfo:nil];
        return nil;
    }
